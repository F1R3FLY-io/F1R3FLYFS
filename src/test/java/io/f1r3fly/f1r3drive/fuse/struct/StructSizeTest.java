...
public class StructSizeTest {
  ...
  private static Map<Class<?>, Map<jnr.ffi.Platform.OS, PlatformSize>> sizes =
      Utils.asMap(
          Utils.Pair.pair(
              Statvfs.class,
              Utils.asMap(
  ...
  public static void init() {
    if (!Platform.IS_32_BIT && !Platform.IS_64_BIT) {
      throw new IllegalStateException(
          "Unknown platform " + System.getProperty("sun.arch.data.model"));
    }
    System.out.println(
        "Running struct size test\nPlatform: " + Platform.ARCH + "\nOS: " + Platform.OS_NAME);
  }
