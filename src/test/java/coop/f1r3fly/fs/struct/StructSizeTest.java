...
import static coop.f1r3fly.fs.struct.Utils.Pair.pair;
import static coop.f1r3fly.fs.struct.PlatformSize.platformSize;
import static jnr.ffi.Platform.OS.*;
import static coop.f1r3fly.fs.struct.Utils.asMap;
