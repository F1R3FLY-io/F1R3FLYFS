...
import io.f1r3fly.f1r3drive.fuse.struct.*;
...
import io.f1r3fly.f1r3drive.fuse.utils.SecurityUtils;
import io.f1r3fly.f1r3drive.fuse.utils.WinPathUtils;
...
public abstract class AbstractFuseFS implements FuseFS {
    ...
    public void mount(Path mountPoint, boolean blocking, boolean debug, String[] fuseOpts) {
        if (!mounted.compareAndSet(false, true)) {
            throw new FuseException("Fuse f1r3drive already mounted!");
        }
