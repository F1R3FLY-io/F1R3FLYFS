...
import io.f1r3fly.f1r3drive.fuse.flags.IoctlFlags;
import io.f1r3fly.f1r3drive.fuse.flags.XAttrConstants;
...
public interface FuseFS extends Mountable {
     ...
     *             is created. @see coop.f1r3fly.f1r3drive.struct.FileStat flags
     */
     ...
     *
     * @param mask see @{link coop.f1r3fly.f1r3drive.flags.AccessConstants}
     ...
     * coop.f1r3fly.f1r3drive.AbstractFuseFS#isBufOperationsImplemented()
     */
