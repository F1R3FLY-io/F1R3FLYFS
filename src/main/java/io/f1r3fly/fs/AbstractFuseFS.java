...
public abstract class AbstractFuseFS implements FuseFS {
    ...
    public void mount(Path mountPoint, boolean blocking, boolean debug, String[] fuseOpts) {
        ...
        if (!debug) {
            arg = new String[]{this.mountName, "-o", "volname=" + this.mountName, "-o", "fsname=" + this.mountName, "-f", mountPointStr};
        } else {
            arg = new String[]{this.mountName, "-o", "volname=" + this.mountName, "-o", "fsname=" + this.mountName, "-f", "-d", mountPointStr};
        }
