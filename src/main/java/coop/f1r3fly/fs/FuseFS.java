...
public interface FuseFS extends Mountable {
     ...
     *             is created. @see coop.f1r3fly.fs.struct.FileStat flags
     */
     ...
     * is SIZE bytes long).
     *
     * @param flags @see {@link coop.f1r3fly.fs.flags.XAttrConstants}
     ...
     *
     * @param mask see @{link coop.f1r3fly.fs.flags.AccessConstants}
     ...
     *
     * @param flags See {@link coop.f1r3fly.fs.flags.IoctlFlags}
     */
     ...
     * coop.f1r3fly.fs.AbstractFuseFS#isBufOperationsImplemented()
     */
     ...
     * interesting for network filesystems and similar.
     *
     * @param op see {@link coop.f1r3fly.fs.struct.Flock}
     */
